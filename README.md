...
默认标定参数定义在 `power-window-anti-pinch-controller/config/PowerWindow_Cfg.h` 中：
...
- [📋 API 接口文档](power-window-anti-pinch-controller/docs/api.md) - 完整的 API 文档
- [🔄 状态机设计文档](power-window-anti-pinch-controller/docs/state_machine.md) - 状态转换和条件
- [🧪 测试说明文档](power-window-anti-pinch-controller/docs/testing.md) - 测试环境和执行
...
- [🇨🇳 项目介绍指南](power-window-anti-pinch-controller/项目介绍指南.md) - 中文项目介绍
- [📊 技术汇报文档](power-window-anti-pinch-controller/技术汇报文档.md) - 技术成果汇报
